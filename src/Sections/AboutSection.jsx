  ...
  return (
    ...
    <section className={`${Styles.paddingX} ${Styles.paddingY} mt-24`}>
        ...
        <motion.div variants={fadeIn("up", "tween", index * 0.50, 0.50)} key={item.personalInfo}>
          ...
          <h1 className='text-xl font-semibold'> <span className="text-gray-600 dark:text-gray-500">{item.personalInfo}</span> <span className="font-black poppins dark:text-white">{item.response}</span></h1>
          <h1 className='text-xl font-semibold'> <span className="text-gray-600 dark:text-gray-500">{item.personalInfo2}</span> <span className="font-black poppins dark:text-white">{item.response2}</span></h1>
          </div>
