  ...
  return (
    <section className={`${Styles.paddingY} ${Styles.paddingX} mt-10`}>
      ...
      <div className="mt-10">
        ...
        <motion.h1 variants={textVariant(0.30)} className='font-bold sm:text-lg text-sm text-center dark:text-white leading-7'>As a passionate developer, I thrive on collaboration, harnessing collective strengths
