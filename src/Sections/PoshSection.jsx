    ...
    <section className={`${Styles.paddingY} ${Styles.paddingX} mt-10`}>
        ...
        <motion.h1 variants={zoomIn(0.70, 1)} className='sm:text-7xl xm:text-5xl text-4xl -z-0 flex justify-center absolute text-[#51515143]'>PORTFOLIO</motion.h1>
         ...
         <div className="mt-10">
          ...
          <motion.h1 variants={textVariant(0.30)} className='font-bold sm:text-lg text-base py-4 text-center dark:text-white '>As a passionate developer, I thrive on collaboration, harnessing collective strengths
