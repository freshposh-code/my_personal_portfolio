...
const Contact = () => {
  ...
  return (
    <section className={`${Styles.paddingX} ${Styles.paddingY} bg-white dark:bg-gray-900 sm:rounded-t-[50%] rounded-t-[180px] sm:rounded-b-[10%] rounded-b-[100px] mt-6`} id="contactme">
