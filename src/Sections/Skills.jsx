...
const Skills = () => {
  ...
  return (
    <section className={`${Styles.paddingY} ${Styles.paddingX}`} id='skills'>
      ...
      <motion.p variants={textVariant(0.30)} className="font-semibold text-center sm:text-lg text-sm my-2 dark:text-white leading-7"><span className="text-xl font-extrabold">Technical Proficiencies.</span> This succinctly indicates the
