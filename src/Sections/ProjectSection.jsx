...
const ProjectSection = () => {
  return (
    <section className={`${Styles.paddingY} ${Styles.paddingX}`} id='project'>
      ...
      <p className='font-semibold text-center sm:text-lg text-sm py-5 leading-7 dark:text-white'>
      ...
      <div className='flex flex-wrap gap-5 mt-5 justify-center'>
        {project.map((item, index) => (
          <motion.div initial='hidden' whileInView='show'
            ...
            variants={fadeIn('up', 'tween', index * 0.25, 0.45)} className={`${item.cardShadow} sm:p-[12px] xm:p-[11px] p-[9px] rounded-xl relative`} key={item.id}>
